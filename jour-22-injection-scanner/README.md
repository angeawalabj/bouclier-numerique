...
Crawl HTML · SQLi error-based + time-based · XSS réfléchi · SSTI · Command Injection · Rapport HTML

---

## Problème résolu

OWASP A03:2021 (Injection) reste l'une des catégories de vulnérabilités les plus répandues. Une seule injection SQL non détectée peut mener à l'exfiltration complète d'une base de données. Ce scanner automatise ce que ferait un pentesteur lors de la phase de test des entrées.
...
- Bibliothèque de payloads couvrant 5 types d'injection
- App de démonstration Flask volontairement vulnérable intégrée
- Rapport HTML avec score de sécurité, preuves et remédiations
...
---
_Partie du challenge [Le Bouclier Numérique](../README.md) — Jour 22/30_
