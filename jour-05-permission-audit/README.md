...
Détection des permissions excessives, fichiers world-writable, SUID
dangereux, avec export de rapport. Python 3.10+, compatible Linux/macOS/
Windows.
...
_Partie du challenge [Le Bouclier Numérique](../README.md) — Jour 05/30_
