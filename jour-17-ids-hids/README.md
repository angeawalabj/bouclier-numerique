# Jour 17 — Détecteur d'Infiltration HIDS (File Integrity Monitor)

Détecte toute modification non autorisée des fichiers système en moins de
30 secondes : baseline SHA-256, alertes temps réel, surveillance des
permissions. Python 3.10+.
...
## Conformité — PCI-DSS 10.5.5 obligatoire
...
_Partie du challenge [Le Bouclier Numérique](../README.md) — Jour 17/30_
